...
function RandomMount:Summon(type)
    ...
    if not IsMounted() then
        ...
        for _,id in pairs(collected) do
            ...
            if db.random.mounts[id] ~= nil and db.random.mounts[id] ~= false and IsUsableSpell(id) ~= nil and summonable==true then
        ...
        elseif #slow_mounts > 0 then
            ...
            if IsIndoors() == false and UnitAffectingCombat("player") == false then

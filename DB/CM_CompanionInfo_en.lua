CollectMeCompanionInfo = {
    [62514] = "Not available on live servers. [BoP]", -- Alarming Clockbot
    [10713] = "Sold by Breanni <Pet Supplies> in the Magical Menageriein, Dalaran for 50g. [BoE]", -- Albino Snake
    ...
    [10685] = "Sold by 'Plucky' Johnson in Tirth's Haunt, Thousand Needles for 1G. [BoE]", -- Ancona Chicken
    [62746] = "Reward from the 'A Champion Rises' quest at the Argent Tournament. [BoP]", -- Argent Gruntling
    [62609] = "Reward from the 'A Champion Rises' quest at the Argent Tournament. [BoP]", -- Argent Squire
    [89670] = "Reward from Critter Kill Squad guild achievement (Kill 50,000 critters). [BoP]", -- Armadillo Pup
    [10696] = "Zone drop in Winterspring. [BoE]", -- Azure Whelpling
    [61855] = "Obtained by logging in during the 4th anniversary of World of Warcraft. Unique [BoA]", -- Baby Blizzard Bear
    [25849] = "Not available on live servers. [BoE]", -- Baby Shark
    [40549] = "Loot reward from 'Through the Dark Portal' TCG expansion. [BoP]", -- Bananas
    [10714] = "Sold by Xan'tish in the Valley of Spirits, Orgrimmar for 50S. [BoE]", -- Black Kingsnake
    [10675] = "Zone drop in Hillsbrad Foothills. [BoE]", -- Black Tabby Cat
    [75134] = "Sold by Jepetto Joybuzz <Toymaker> in the Wonderworks, Dalaran for 50g. [BoP]", -- Blue Clockwork Rocket Bot
    [36031] = "Sold by Dealer Rashaad <Exotic Creatures> in the Stormspire, Netherstorm for 10G. [BoE]", -- Blue Dragonhawk Hatchling
    [78683] = "Reward from 'Egg Wave' quest in Mount Hyjal. [BoP]", -- Blue Mini Jouster
    [35907] = "Sold by Sixx <Moth Keeper> in the Crystal Hall, Exodar for 50S. [BoE]", -- Blue Moth
    [10673] = "Sold by Donni Anthania <Crazy Cat Lady> in the Elwynn Forest for 40S. [BoE]", -- Bombay Cat
    ...
    [54187] = "Chance of dropping from a Stolen Present obtained from the quest 'You're a Mean One...'. Unique [BoP]", -- Clockwork Rocket Bot
    ...
    [23811] = "Reward from the 'Quest Spawn of Jubjub' stared by Morja at Darkmoon Faire. Unique [BoP]", -- Jubling
    ...
    [27570] = "Contained in the Gifts of Adoration from the Love is in the Air festival. [BoE]", -- Peddlefeet
    ...
    [44369] = "Sold by Brewfest vendors for 100 Brewfest Prize Tokens. [BoE]", -- Pint-Sized Pink Pachyderm
    ...
    [45890] = "Rare loot from Zen'Vorka's Cache which can be purchased from Zen'Vorka for 30x Mark of the World Tree. [BoP]", -- Searing Scorchling
    ...
    [42609] = "Dropped by the Headless Horseman and contained in Crudely Wrapped Gift and Treat Bag during Hallow's End. [BoE]", -- Sinister Squashling
    [16450] = "Dropped by Mother Smolderweb in Lower Blackrock Spire. [BoP]", -- Smolderweb Hatchling
    ...
    [68810] = "Loot reward from 'Scourgewar' TCG expansion.  [BoP]", -- Spectral Tiger Cub
    ...
    [28871] = "Sold by Midsummer Supplier and Midsummer Merchant in the capital cities for 350 Burning Blossoms during the Midsummer's Festival. Unique [BoE]", -- Spirit of Summer
    [61725] = "Can be bought for 100 Chocolate Eggs or random drop in an Egg on the Noblegarden festival. [BoE]", -- Spring Rabbit
    [15067] = "Zone drop in Feralas. [BoP]", -- Sprite Darter Hatchling
    ...
    [10704] = "Sold by Flik in the Darkmoon Faire for 1G. [BoE]", -- Tree Frog
    [68767] = "Loot reward from 'Scourgewar' TCG expansion.  [BoP]", -- Tuskarr Kite
    ...
    [10703] = "Sold by Flik in the Darkmoon Faire for 1G (Limited Supply). [BoE]", -- Wood Frog
    [15999] = "Dropped by Quartermaster Zigris in Lower Blackrock Spire. [BoP]", -- Worg Pup
    ...
    [103125] = "Chance of dropping from a Stolen Present obtained from the quest 'You're a Mean One...'. Unique [BoP]", -- Lumpy
    [110029] = "Purchased from Blizzard's online store. Unique [BoA]", -- Soul of the Aspects
    [104047] = "Purchased from Valadar Starsong in Moonglade for 50 Coins of Ancestry by an Alliance character.  [BoE]", -- Lunar Lantern
    [104049] = "Purchased from Valadar Starsong in Moonglade for 50 Coins of Ancestry by a Horde character.  [BoE]", -- Festival Lantern
    [112994] = "Loot reward from 'War of the Ancients' TCG expansion.  [BoP]", -- Eye of the Legion
}
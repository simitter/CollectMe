...
L["title_231"] = "Unknown method of obtaining." -- the Poisoned Mind
L["title_232"] = "Unknown method of obtaining." -- the Bloodseeker
L["title_233"] = "Unknown method of obtaining." -- the Locust
L["title_234"] = "Unknown method of obtaining." -- the Swarmkeeper
L["title_235"] = "Unknown method of obtaining." -- the Prime
L["title_236"] = "Unknown method of obtaining." -- the Manipulator
L["title_237"] = "Unknown method of obtaining." -- the Disector
L["title_238"] = "Unknown method of obtaining." -- the Lucid
L["title_239"] = "Unknown method of obtaining." -- the Wind-Reaver
L["title_240"] = "Reward for 'Crazy for Cats' achievement wich required you to capture a variety of battle pets." -- the Crazy Cat Lady
L["title_241"] = "Reward for holding realm best time in challange mode 'Gate of the Setting Sun'. Removed if someone is faster than you."  -- Defender of the Wall
L["title_242"] = "Reward for holding realm best time in challange mode 'Mogushan Palace'. Removed if someone is faster than you."  -- Mogu Slayer
L["title_243"] = "Reward for holding realm best time in challange mode 'Scarlet Halls'. Removed if someone is faster than you."  -- Flameweaver
L["title_244"] = "Reward for holding realm best time in challange mode 'Scarlet Monastery'. Removed if someone is faster than you."  -- Scarlet Commander
L["title_245"] = "Reward for holding realm best time in challange mode 'Scholomance'. Removed if someone is faster than you."  -- Darkmaster
L["title_246"] = "Reward for holding realm best time in challange mode 'Shado-pan Monastery'. Removed if someone is faster than you."  -- Purified Defender
L["title_247"] = "Reward for holding realm best time in challange mode 'Siege of Niuzao Temple'. Removed if someone is faster than you."  -- Siegebreaker
L["title_248"] = "Reward for holding realm best time in challange mode 'Stormstour Brewery'. Removed if someone is faster than you."  -- Stormbrewer
L["title_249"] = "Reward for holding realm best time in challange mode 'Temple of the Jade Serpent'. Removed if someone is faster than you."  -- Jade Protector
L["title_251"] = "Reward for 'Fire-Catcher' achievement wich required you to obtain 10000 Bloody Coins as an Emissary of Ordos or Ordon Fire-Watcher." -- Fire-Watcher
L["title_252"] = "Reward for 'Crazy for Cats' achievement wich required you to capture a variety of battle pets." -- the Crazy Cat Man
L["title_253"] = "Awarded per battlegroup at the end of arena season 14 based on top ranked percentage. Top 0.0% - 0.5%." -- Grivious Gladiator
L["title_254"] = "Awarded per battlegroup at the end of arena season 15 based on top ranked percentage. Top 0.0% - 0.5%." -- Prideful Gladiator

...
L["title_203"] = "From Tranquil Master, requiring players to kill all the Sha-themed NPCs, which are from quests, dungeons, raids, and world spawns: Sha of Doubt, Sha of Violence, Sha of Anger, Sha of Despair, Sha of Hatred, Sha of Fear." -- the Tranquil Master
...
L["title_205"] = "Complete The Shado-Master, doing a bunch of achievements tied to dailies with Shado-Pan, similar to The Flamebreaker from the Molten Front." -- Shadow-Master  // misspelled comment?
L["title_206"] = "Reward for completing 'Scenaterday/ Scenaterday' doing all the new Scenarios on a Saturday." -- the Scenaterdist
L["title_207"] = "!This title is awarded once you defeat all of the Pet Tamers across Azeroth" -- Tamer
L["title_208"] = "Reward for completing World Safari, all the Pet Safari achievements, requiring you to collect and capture a ton of pets." -- Seeker of Knowledge

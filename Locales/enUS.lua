...
L["mount_58615"] = "Won by the top 0.5% rated Arena groups in the battlegroup in Season 4. (100%) [BoP]" -- Brutal Nether Drake
...
L["mount_36702"] = "Dropped by Attumen the Huntsman in Karazhan. (?%) [BoP]" -- Fiery Warhorse
...
L["mount_61294"] = "Contained the Mysterious Egg which can be bought from Geen in Sholazar Basin with a The Oracles reputation of at least revered. (?%) [SoEM] [BoP]" -- Green Proto-Drake
...
L["mount_43900"] = "Dropped by Coren Direbrew in Blackrock Depths during Brewfest. (?%)[BoP]" -- Swift Brewfest Ram
...
L["mount_61451"] = "Recipe to create it is taught by Grand Master Tailoring Trainers. [BoE]" -- Flying Carpet
L["mount_75596"] = "Recipe to create it is purchased for 6 Frozen Orbs from Frozo the Renowned in Dalaran, Requires Tailoring 425. [BoE]" -- Frosty Flying Carpet
...
L["mount_127286"] = "Sold by Old Whitenose (Alliance) in ??? and Turtlemaster Odai in ??? for 1G. You need to be exalted with the Pandaren. [BoP]" -- Black Dragon Turtle
...
L["mount_127287"] = "Sold by Old Whitenose (Alliance) in ??? and Turtlemaster Odai in ??? for 1G. You need to be exalted with the Pandaren. [BoP]" -- Blue Dragon Turtle
...
L["mount_127288"] = "Sold by Old Whitenose (Alliance) in ??? and Turtlemaster Odai in ??? for 1G. You need to be exalted with the Pandaren. [BoP]" -- Brown Dragon Turtle
...
L["mount_127295"] = "Sold by Old Whitenose (Alliance) in ??? and Turtlemaster Odai in ??? for 10G. You need to be exalted with the Pandaren. [BoP]" -- Great Black Dragon Turtle
L["mount_127302"] = "Sold by Old Whitenose (Alliance) in ??? and Turtlemaster Odai in ??? for 10G. You need to be exalted with the Pandaren. [BoP]" -- Great Blue Dragon Turtle
L["mount_127308"] = "Sold by Old Whitenose (Alliance) in ??? and Turtlemaster Odai in ??? for 10G. You need to be exalted with the Pandaren. [BoP]" -- Great Brown Dragon Turtle
L["mount_127293"] = "Sold by Old Whitenose (Alliance) in ??? and Turtlemaster Odai in ??? for 10G. You need to be exalted with the Pandaren. [BoP]" -- Great Green Dragon Turtle
L["mount_127293"] = "Sold by Old Whitenose (Alliance) in ??? and Turtlemaster Odai in ??? for 10G. You need to be exalted with the Pandaren. [BoP]" -- Great Purple Dragon Turtle
L["mount_120822"] = "Sold by Old Whitenose (Alliance) in ??? and Turtlemaster Odai in ??? for 10G. You need to be exalted with the Pandaren. [BoP]" -- Great Red Dragon Turtle
L["mount_120395"] = "Sold by Old Whitenose (Alliance) in ??? and Turtlemaster Odai in ??? for 10G. You need to be exalted with the Pandaren. [BoP]" -- Green Dragon Turtle
...
L["mount_127289"] = "Sold by Old Whitenose (Alliance) in ??? and Turtlemaster Odai in ??? for 1G. You need to be exalted with the Pandaren. [BoP]" -- Purple Dragon Turtle
L["mount_127290"] = "Sold by Old Whitenose (Alliance) in ??? and Turtlemaster Odai in ??? for 1G. You need to be exalted with the Pandaren. [BoP]" -- Red Dragon Turtle
